...
func NewServerServiceHTTPServer(srv ServerServiceServer, logger *logrus.Entry) http.Handler {
	r := mux.NewRouter()

	r.HandleFunc("/layout/test", func(w http.ResponseWriter, r *http.Request) {
		var req TestRequest
